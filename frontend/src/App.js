...
import ChatbotInterviewer from './ChatbotInterviewer'; // Import for the AI Chatbot session
import InterviewScheduler from './components/InterviewScheduler'; // Import the InterviewScheduler component
import './App.css';
...
function App() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!selectedFile || !jobDescription || !jobTitle) {
            ...
            <div className="App">
                <header className="App-header">
                    ...
                    <nav>
                        ...
                        <Link to="/job-descriptions" className="nav-link">Job Descriptions</Link>
                        {/* Updated NAV LINK for AI Interviewer to point to scheduling */}
                        <Link to="/schedule-interview" className="nav-link">Schedule AI Interview</Link>
                    </nav>
                </header>
                <main>
                    <Routes>
                        ...
                        <Route path="/job-descriptions" element={<JobDescriptionList />} />

                        {/* Route for the Interview Scheduler (where you select job/candidate for scheduling) */}
                        <Route path="/schedule-interview" element={<InterviewScheduler />} />

                        {/* Route for the actual AI Chatbot Interview session */}
                        <Route path="/interview/:candidateId/:jobId" element={<ChatbotInterviewer />} />

                        {/* Removed the redundant /interview and /interviewer placeholder routes */}
